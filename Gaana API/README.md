...
```sh
https://gaana.stonemusic.in/songs/search?query=<insert-query-here>&limit=<insert-limit-here, eg. 5>
```
**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/songs/search?query=tyler herro` to get a JSON response of song results in return.

---
##### **Search For Albums**: (Requires a search query, limit is optional)
```sh
https://gaana.stonemusic.in/albums/search?query=<insert-query-here>&limit=<insert-limit-here, eg. 5>
```
**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/albums/search?query=all over the place` to get a JSON response of album results in return.

----
##### **Search For Artists**: (Requires a search query, limit is optional)
```sh
https://gaana.stonemusic.in/artists/search?query=<insert-query-here>&limit=<insert-limit-here, eg. 5>
```
**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/artists/search?query=KSI` to get a JSON response of arist results in return.

----
##### **Get Song Info**: (Requires a SEOKEY)
```sh
https://gaana.stonemusic.in/songs/info?seokey=SEOKEY
```
...
**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/songs/info?seokey=tyler-herro` to get a JSON response of the song's info in return.

----
##### **Get Album Info**: (Requires a SEOKEY)
```sh
https://gaana.stonemusic.in/albums/info?seokey=ALBUM_SEOKEY
```
...
**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/albums/info?seokey=tyler-herro` to get a JSON response of the song's info in return.

----
##### **Get Artist Info**: (Requires a SEOKEY)
```sh
https://gaana.stonemusic.in/artists/info?seokey=SEOKEY
```
...
**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/artists/info?seokey=jack-harlow` to get a JSON response of the artists's info in return.

----
##### **Get Playlist Info**: (Requires a SEOKEY)

```sh
https://gaana.stonemusic.in/playlists/info?seokey=SEOKEY
```
...
**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/playlists/info?seokey=gaana-dj-gaana-international-top-50` to get a JSON response of the playlists's info in return.

----
##### **Get Trending Tracks**: (Requires a LANGUAGE)
```sh
https://gaana.stonemusic.in/trending?lang=LANGUAGE
```
...
**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/trending?lang=English` to get a JSON response of the trending English songs in return.

----
##### **Get New Releases**: (Requires a LANGUAGE)
```sh
https://gaana.stonemusic.in/newreleases?lang=LANGUAGE
```
**Language Options:** English, Hindi, Punjabi, Telugu, Tamil etc. (Warning: Case Sensitive!). Defaults to Hindi if no language is provided or if an invalid language is entered.

**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/newreleases?lang=English` to get a JSON response of both new English songs and English albums in return.

----
##### **Get Charts**:
```sh
https://gaana.stonemusic.in/charts
```

**Example:** Create a GET request or navigate to `https://gaana.stonemusic.in/charts` to get a JSON response of the top charts.